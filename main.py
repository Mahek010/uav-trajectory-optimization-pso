...
def run(output_dir="results"):
    ...
    summary = {
        ...
        "optimized_collision_penalty": collision_penalty(
            optimized_path, obstacles, scenario.safety_margin
        ),
        "baseline_collision_penalty": collision_penalty(
            baseline, obstacles, scenario.safety_margin
        ),
    }
